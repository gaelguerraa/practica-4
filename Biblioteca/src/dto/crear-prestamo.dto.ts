...
export type PrestamoResponseDTO = Omit<Prestamo, 'costoReposicion'>;

export function toPrestamoResponseDTO(prestamo: Prestamo): PrestamoResponseDTO {
    const { costoReposicion, ...resto } = prestamo;
    return resto;
}